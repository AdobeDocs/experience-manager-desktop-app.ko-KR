...
AEM Assets 서버를 성능에 맞게 최적화하는 방법을 이해하려면 [AEM Assets 성능 조정 가이드](https://experienceleague.adobe.com/ko/docs/experience-manager-65/content/assets/administer/performance-tuning-guidelines)로 이동하십시오. AEM 데스크탑 앱에 대한 서버 성능의 몇 가지 중요한 측면은 자산 업로드에 잘 수행되도록 워크플로우 구성을 최적화하는 것입니다.

* **추가 성능 자산 업로드**. [AEM 자산 업데이트 워크플로 모델을 임시](https://experienceleague.adobe.com/ko/docs/experience-manager-65/content/assets/administer/performance-tuning-guidelines)로 구성하십시오.
